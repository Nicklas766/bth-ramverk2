...
setup-tools-js:
	@$(call HELPTEXT,$@)
	npm install --save-dev htmlhint csslint stylelint eslint eslint-plugin-react jsonlint js-yaml html-minifier clean-css-cli uglify-js mocha nyc coveralls codecov
